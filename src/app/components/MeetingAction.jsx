  ...
  return (
    ...
    <div className='flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4'>
         ...
         <div className='flex w-full sm:w-auto relative'>
          ...
          <Button
           variant="secondary"
           className="rounded-l-none bg-black text-white hover:text-white hover:bg-zinc-900 dark:bg-white dark:text-black dark:hover:bg-gray-200 dark:hover:text-black"
